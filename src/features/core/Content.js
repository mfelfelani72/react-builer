...
const Content = () => {
  return (
    <>
      <aside
        className="fixed top-0 left-0 rtl:right-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
      ...
      <div className="p-4 ltr:sm:ml-64 rtl:sm:mr-64">
