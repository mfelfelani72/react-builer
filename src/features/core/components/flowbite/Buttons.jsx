  ...
  return (
    <>
      <div className="container mx-auto">
        <h2 className="pb-2">Default button</h2>
        ...
        <button
          type="button"
          className="focus:outline-none text-white bg-lime-700 hover:bg-lime-800 focus:ring-4 focus:ring-lime-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-lime-600 dark:hover:bg-lime-700 dark:focus:ring-lime-800"
        >
          lime
        </button>
        <button
        ...
        <button
          type="button"
          className="focus:outline-none text-white bg-orange-600 hover:bg-orange-700 focus:ring-4 focus:ring-orange-400 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-orange-900"
        >
          amber
        </button>
        <button
        ...
        <h2 className="py-5 pb-2 text-sm">Gradient outline</h2>
        ...
        <div className="z-10">
          ...
          <button className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-lime-400 to-blue-600 group-hover:from-lime-400 group-hover:to-blue-600 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-lime-200 dark:focus:ring-lime-800">
            <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
              lime to blue
            </span>
          </button>
          ...
          <button className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-rose-200 via-rose-300 to-amber-200 group-hover:from-rose-200 group-hover:via-rose-300 group-hover:to-amber-200 dark:text-white dark:hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-rose-100 dark:focus:ring-rose-400">
            <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
              rose to amber
            </span>
          </button>
        ...
        <h2 className="py-5 pb-2 text-sm">Social buttons </h2>
        ...
        <div className="">
          ...
          <button
            type="button"
            className="text-white bg-[#1570a8] hover:bg-[#1da1f2]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 me-2 mb-2"
          >
            <svg
              className="w-4 h-4 me-2"
              aria-hidden="true"
          ...
          <button
            type="button"
            className="text-white bg-[#2d5ba5] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2"
          >
            <svg
              className="w-4 h-4 me-2"
              aria-hidden="true"
      ...
      <div className="mx-4">
        <h2 className="py-5 pb-2 text-sm">Payment buttons</h2>
       ...
       <button
        ...
        <button
          type="button"
          className="text-white bg-orange-600 hover:bg-[#FF9119]/80 focus:ring-4 focus:outline-none focus:ring-[#FF9119]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#FF9119]/80 dark:focus:ring-[#FF9119]/40 me-2 mb-2"
        >
          <svg
      ...
      <div className="mx-4">
        <h2 className="py-5 pb-2 text-sm">Buttons with icon</h2>
